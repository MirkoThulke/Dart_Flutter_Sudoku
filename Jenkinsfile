...
Author: MIRKO THULKE
Copyright (c) 2026, MIRKO THULKE
All rights reserved.

Date: 2026, VERSAILLES, FRANCE
            ...
            steps {
                script {
                    withEnv(containerEnv) {
                        ...
                        echo "Workspace: \$REPO_CHECKOUT_DIR"
                        echo "Script path: \$PLANTUML_SCRIPT"

                        cd "\$REPO_CHECKOUT_DIR"

                        echo "Running PlantUML generator..."

                        bash "\$PLANTUML_SCRIPT"
                        """
                    }
                }
            }
...
// Copyright (c) 2026, MIRKO THULKE. All rights reserved.
